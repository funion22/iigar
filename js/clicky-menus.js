...
(function() {
	...
	var reset1 = document.querySelectorAll(".s1reset1");
	for(var i = 0; i < reset1.length; i++) {
		reset1[i].innerHTML = "Escribe en la caja de texto arriba para generar la URL asociada a CPM";
	}
	...
	const ClickyMenus = function( menu ) {
		...
		function convertLinkToButton( menuItem ) {
			...
			const 	link = menuItem.getElementsByClassName( 'opencampaigns' )[0],
